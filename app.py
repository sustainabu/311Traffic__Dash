...
from dash.exceptions import PreventUpdate #new
...
url = "https://raw.githubusercontent.com/sustainabu/311Traffic__Dash/main/311trafficQA.parquet"
...
update_date = date(2025, 7, 20) #Update Date
...
def update_graph(start_date, end_date, board, violation):
    ...
    if end_date is None:
        end_date = date(2025, 7, 20)  # Default to the maximum date in the dataset
    else:
